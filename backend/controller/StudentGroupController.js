...
const createGroup = async(req,res,next)=>{
    const {groupId,leaderName,leaderId,leaderEmail,leaderContactNo,
           member_1Name,member_1Id,member_1Email,member_1ContactNo,
           member_2Name,member_2Id,member_2Email,member_2ContactNo,
           member_3Name,member_3Id,member_3Email,member_3ContactNo,
           panelMember_1,panelMember_2,topic} =req.body;
    
    let studentgroup;

    try {
        studentgroup = new StudentGroup({
            groupId,leaderName,leaderId,leaderEmail,leaderContactNo,
           member_1Name,member_1Id,member_1Email,member_1ContactNo,
           member_2Name,member_2Id,member_2Email,member_2ContactNo,
           member_3Name,member_3Id,member_3Email,member_3ContactNo,
           panelMember_1,panelMember_2,topic
        });
